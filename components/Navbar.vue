...
<template>
    <nav
        class="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-900 via-15% text-white dark:from-blue-900 dark:to-slate-900 dark:text-neutral-100">
        <div class="lg:container mx-auto px-3 lg:px-0">
            <div class="flex justify-between items-center h-14">
                ...
                <div class="lg:hidden flex items-center">
                    <button @click="isOpen = !isOpen" name="menu">
